      ...
      <section>
        ...
        <div className="flex gap-10">
          <ul className="text-sm my-4 capitalize">
            ...
            <li className="hover:underline"><Link href={'/about'}>Who we are</Link></li>
            <li className="hover:underline"><Link href={'/contact'}>Contact Information</Link></li>
            <li className="hover:underline"><Link href={'/advertise'}>Advertise</Link></li>
          </ul>
          <ul className="text-sm my-4 capitalize">
