...
const Authentication = () => {
  ...
  return (
    <div className="col-span-2 font-secondary authenticate py-10 md:py-0 md:h-svh relative flex items-center justify-center">
        ...
        <section className="p-4 flex flex-col gap-4">
            ...
            <form className="flex flex-col gap-4">
                ...
                <div className="border-b  py-1 flex gap-2 items-center">
                    ...
                    <input onChange={handleInput} type="text" id="username" name="username" placeholder="Username" className="min-w-[70svw] md:min-w-[300px] bg-transparent"/>
                </div>
                }
                <div className="border-b  py-1 flex gap-2 items-center">
                    ...
                    <input onChange={handleInput} type="email" id="email" name="email" placeholder="Email" className="min-w-[70svw] md:min-w-[300px] bg-transparent"/>
                </div>
                <div className="border-b  py-1 flex gap-2 items-center">
                    ...
                    <input onChange={handleInput} type="password" id="password" name="password" placeholder="Password" className="min-w-[70svw] md:min-w-[300px] bg-transparent"/>
                </div>
            ...
            <section>
                ...
                <div className="flex justify-center">
                        <div onClick={handleGoogleSignIn} className="bg-dark cursor-pointer text-light border flex items-center gap-2 py-2 md:w-3/4 justify-center px-4 rounded-md hover:scale-95 transition-all text-sm">
